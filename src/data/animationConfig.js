export const animationData = [
    ...
    },
    {
        ...
        image:"/pictures/bouncing ball.png",
        video:"public/videos/bouncing balls.mp4",
        config: {
            count: 30,
            baseRadius: 10,
            radiusVariation: 20,
    ...
    },
    {
        ...
        image:"/pictures/star field.png",
        video:"public/videos/star field.mp4",
        config: {
            starCount: 200,
            baseSpeed: 5,
            maxStarSize: 5,
    ...
    },
    {
        ...
        image:"/pictures/magnetic particles.png",
        video:"public/videos/magnetic particles.mp4",
        config: {
            particleCount: 100,
            magnetForce: 0.1,
            maxForce: 5,
    ...
    },
    {
        ...
        video:"public/videos/carousel.mp4",
        config: {
            seats: 12,
            radius: 120,
            upDownAmplitude: 30,
    ...
    },
    {
        ...
        video:"public/videos/color waves.mp4",
        config: {
            spacing: 5,
            wave1Frequency: 0.01,
            wave1Amplitude: 50,
    ...
    },
    {
        ...
        video:"public/videos/vortex flow.mp4",
        config: {
            particleCount: 200,
            maxRadius: 300,
            minRadius: 10,
...

    {
        ...
        video:"public/videos/sparkle trail.mp4",
        config: {
            sparklesPerFrame: 3,
            autoSparkles: 2,
            autoRadius: 150,
    ...
    },
    {
        ...
        video:"public/videos/floating bubbles.mp4",
        config: {
            bubbleCount: 50,
            baseSize: 10,
            sizeVariation: 30,
    ...
    },
    {
        ...
        video:"public/videos/petal falls.mp4",
        config: {
            petalCount: 60,
            baseSize: 8,
            sizeVariation: 6,
    ...
    },
    {
        ...
        video:"public/videos/oceab waves.mp4",
        config: {
            waveCount: 5,
            baseAmplitude: 40,
    ...
    },
    {
        ...
        video:"public/videos/snow falls.mp4",
        config: {
            flakeCount: 100,
            baseSize: 3,
            sizeVariation: 5,
    ...
    },
    {
        ...
        video:"public/videos/crysral growth.mp4",
        config: {
            segments: 12,
            maxRadius: 200,
            growthSpeed: 0.5,
    ...
    },
    {
        ...
        video:"public/videos/moon phases.mp4",
        config: {
            moonSize: 80,
            orbitRadius: 150,
            orbitSpeed: 0.02,
    ...
    },
    {
        ...
        video:"public/videos/paint drips.mp4",
        config: {
            dripCount: 15,
            baseSpeed: 2,
            maxLength: 200,
    ...
    },
    {
        ...
        video:"public/videos/mandala blooms.mp4",
        config: {
            petals: 16,
            layers: 5,
            pulseSpeed: 0.03,
    ...
    },
    {
        ...
        video:"public/videos/diamond rains.mp4",
        config: {
            diamondCount: 40,
            baseSize: 8,
            sizeVariation: 8,
    ...
    },
    {
        ...
        video:"public/videos/starbust.mp4",
        config: {
            rayCount: 20,
            pulseSpeed: 0.05,
            rotationSpeed: 0.01,
    ...
    },
    {
        ...
        video:"public/videos/butterfly swarm.mp4",
        config: {
            butterflyCount: 25,
            baseSpeed: 2,
            wingFlapSpeed: 0.2,
    ...
    },
    {
        ...
        video:"public/videos/dna helix.mp4",
        config: {
            strands: 2,
            pointsPerStrand: 100,
            amplitude: 80,
    ...
    },
    {
        ...
        video:"public/videos/liquid ripple.mp4",
        config: {
            rippleCount: 8,
            maxRadius: 300,
            rippleSpeed: 2,
    ...
    },
    {
        ...
        video:"public/videos/ferris wheel.mp4",
        config: {
            gondolas: 16,
            wheelRadius: 140,
            gondolaSize: 12,
    ...
    },
    {
        ...
        video:"public/videos/flame dance.mp4",
        config: {
            particleCount: 150,
            riseSpeed: 3,
            flameHeight: 250,
    ...
    },
    {
        ...
        video:"public/videos/blooming flower.mp4",
        config: {
            flowerCount: 12,
            petalCount: 8,
            bloomSpeed: 0.02,
    ...
    },
    {
        ...
        image:"",
        video:"public/videos/lightning storm.mp4",
        config: {
            boltChance: 0.03,
            segments: 20,
            branchChance: 0.3,
